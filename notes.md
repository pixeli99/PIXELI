  ...
  <li{% if n_exc.size > 10 %} class="with-excerpt"{% endif %}>
    <div class="entry-head">
      ...
      <span class="entry-tail">
        ...
        {% if n.tags and n.tags.size > 0 %}{% for t in n.tags limit: 2 %}{% assign _tenc = t | url_encode %}<a href="{{ '/tags/' | relative_url }}#tag-{{ t | replace: ' ', '-' }}" class="entry-tag"{% unless _tenc contains '%E' %} lang="en"{% endunless %}>{{ t }}</a>{% endfor %}{% endif %}
